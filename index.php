...
<p style="color:crimson;">*The <b>image</b> must be a <b>JPEG</b> format.</p>
...
<p>This was the implementation object, use it wisely:<br>
  <code>const myDZ = new Dropzone("#myDZ", { acceptedFiles: "image/jpeg", maxFilesize: 1, maxFiles: 1, parallelUploads: 1, paramName: "myFile", resizeWidth: 256, resizeHeight: 256, resizeMimeType: "image/jpeg", resizeQuality: 0.5, resizeMethod: "contain" });</code>
</p>
